...
public final class DocumentDevelopmentProfiles {
    ...
    public static final List<String> TOOLS = List.of("list_development_requirements", "read_development_requirement", "read_development_source", "list_development_documents", "list_development_sections", "read_document_resource");
