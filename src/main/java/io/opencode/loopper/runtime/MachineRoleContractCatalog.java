...
public final class MachineRoleContractCatalog {
    public static final String CONTRACT_VERSION = "2026-08-semantic-v4";
    ...
    private static final Map<String, String> CARDS = Map.of(
            ...
            "COMPILER", "Bind indexed DesignFacts to indexed frozen verification capabilities and suggest dependency-ordered groups. Do not invent commands, paths, ids, criteria, source refs, or executable verifier fields.",
