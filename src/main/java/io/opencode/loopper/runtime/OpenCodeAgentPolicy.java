...
final class OpenCodeAgentPolicy {
    ...
    static int stepLimit(OpenCodeClient.SessionProfile profile) {
        ...
        return switch (profile) {
            case KNOWLEDGE_READ_ONLY, GENERAL_READ_ONLY, DESIGNER_INTERACTIVE_READ_ONLY, IMPLEMENTATION, SNAPSHOT_CODE_REVIEW_NO_TOOLS, TEMPLATE_ANALYSIS_NO_TOOLS, TEMPLATE_ANALYSIS_CANDIDATE_NO_TOOLS,
