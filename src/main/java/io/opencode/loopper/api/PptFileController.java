...
public class PptFileController {
    ...
    private final io.opencode.loopper.service.ppt.generation.PptOutputRecovery recovery;
    public PptFileController(PptResources resources,PptJobs jobs,io.opencode.loopper.service.ppt.generation.PptOutputRecovery recovery){this.resources=resources;this.jobs=jobs;this.recovery=recovery;}
    ...
    @PostMapping("/jobs/{job}/retry") public Object retry(@PathVariable String id,@PathVariable String job,@RequestHeader(value="X-Loopper-Local-UI",required=false)String ui){KnowledgeController.requireUi(ui);return recovery.retry(id,job);}
