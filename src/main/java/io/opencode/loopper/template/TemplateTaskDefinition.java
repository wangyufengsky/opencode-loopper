...
public enum TemplateTaskDefinition {
    ...
    SNAPSHOT_CODE_REVIEW("代码审查", "审查冻结目标版本的代码，支持日期增量和全面审查，按功能分析并独立复核"),
    ...
    public View view() {
        return new View(name(), this == SNAPSHOT_CODE_REVIEW ? "1" : VERSION, title, description, CONTENT_REPAIR_LIMIT,
                this == SNAPSHOT_CODE_REVIEW ? List.of("冻结证据", "规划范围", "功能分析", "独立复核与报告") : List.of("采集 Git 证据", "分析与生成报告"),
