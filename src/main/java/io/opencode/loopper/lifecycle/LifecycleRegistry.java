...
public final class LifecycleRegistry {
    ...
    public LifecycleRegistry() {
        ...
        register(LifecycleMachineType.DOCUMENT_MODEL_RUN, TemplateBatchState.class,
    ...
    private static FiniteStateMachine<DesignWorkPackageState, LifecycleEvent> workPackage() {
        return machine(LifecycleMachineType.DESIGN_WORK_PACKAGE, DesignWorkPackageState.class)
                ...
                .transition(DesignWorkPackageState.PENDING, REQUIRE_INPUT, DesignWorkPackageState.WAITING_INPUT)
                .transition(DesignWorkPackageState.STALE, REQUIRE_INPUT, DesignWorkPackageState.WAITING_INPUT)
                .transition(DesignWorkPackageState.REVIEWING, REQUIRE_INPUT, DesignWorkPackageState.WAITING_INPUT)
