-- Preserve all V70 data and guards; allow an immutable opt-in correction limit for every MCP role.
PRAGMA foreign_keys=OFF;
PRAGMA legacy_alter_table=ON;
SAVEPOINT candidate_submission_v71;

ALTER TABLE ai_candidate_submission_run RENAME TO ai_candidate_submission_run_v70;
...
INSERT INTO ai_candidate_submission_run SELECT * FROM ai_candidate_submission_run_v70;
DROP TABLE ai_candidate_submission_run_v70;
...
CREATE TEMP TABLE candidate_submission_v71_fk_guard (violations INTEGER CHECK (violations=0));
INSERT INTO candidate_submission_v71_fk_guard SELECT COUNT(*) FROM pragma_foreign_key_check
  WHERE "table"='ai_candidate_submission_run' OR parent='ai_candidate_submission_run';
DROP TABLE candidate_submission_v71_fk_guard;
RELEASE candidate_submission_v71;
