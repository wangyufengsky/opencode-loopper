...
class OpenCodePermissionPolicyTest {
    ...
    @Test
    void rollingPackageCandidateAllowsReadEvidenceAndOnlyTheExactInternalSubmissionTool() {
        var rules = OpenCodePermissionPolicy.rules(
    ...
    @Test
    void reviewerCandidateAllowsReadEvidenceAndOnlyTheExactInternalSubmissionTool() {
        var rules = OpenCodePermissionPolicy.rules(
    ...
    @Test
    void judgeCandidateAllowsReadEvidenceAndOnlyTheExactInternalSubmissionTool() {
        var rules = OpenCodePermissionPolicy.rules(
