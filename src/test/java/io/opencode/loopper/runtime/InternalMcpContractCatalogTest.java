...
class InternalMcpContractCatalogTest {
    ...
    void exposesOneStronglyTypedToolPerCandidateRoleAndKeepsTheLegacyNameForRecovery() {
        assertThat(InternalMcpContractCatalog.toolNames()).containsExactly(
                ...
                "submit_document_code_assessment",
                "submit_document_code_review",
                "submit_document_requirements",
                ...
                "list_requirement_code",
                "read_requirement_code",
                "search_requirement_code",
                "list_requirement_assessments",
                "read_requirement_assessment",
                "list_development_requirements",
                "read_development_requirement",
