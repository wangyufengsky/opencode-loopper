...
class KnowledgeControllerTest {
    @Test void writeAuthorizationRunsBeforeAnyModelOrSourceOperation() throws Exception {
        ...
        var mvc=MockMvcBuilders.standaloneSetup(new KnowledgeController(conversations,coordinator,new KnowledgeEventHub(),questions),new KnowledgeSourceController(sources,reader,databases,git)).setControllerAdvice(new ApiExceptionHandler()).build();
