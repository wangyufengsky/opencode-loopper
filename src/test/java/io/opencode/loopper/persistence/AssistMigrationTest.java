...
class AssistMigrationTest {
    ...
    @Test void upgradesV81AndKeepsTheOriginalSchemaHistory() throws Exception {
        ...
        var flyway=Flyway.configure().dataSource(url,null,null).locations("classpath:db/migration").load();assertThat(flyway.migrate().migrationsExecuted).isEqualTo(31);flyway.validate();
