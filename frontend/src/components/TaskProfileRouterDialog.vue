...
.router-runtime { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; margin: 14px 0 0; }.router-runtime div, .profile-result-grid article { padding: 12px; border: 1px solid var(--color-border-soft); border-radius: calc(var(--radius-control) + 3px); background: rgb(var(--shade-surface-01-rgb) / 42%); }.router-runtime dt, .profile-result-grid span { color: var(--color-text-secondary); font-size: 10px; }.router-runtime dd { margin: 5px 0 0; color: var(--color-text-primary); font: 11px var(--font-code); }
