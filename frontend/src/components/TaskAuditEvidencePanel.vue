...
.audit-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 18px; padding: 20px 20px 0; border-bottom: 1px solid rgb(var(--shade-secondary-05-rgb) / 10%); }
...
.source-note { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 9px; padding: 10px 12px; border: 1px solid rgb(var(--shade-cyan-01-rgb) / 15%); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-cyan-01-rgb) / 4%); color: var(--color-text-secondary); font-size: 11px; line-height: 1.55; }
...
.audit-stack { display: grid; gap: 9px; margin-top: 12px; }.audit-disclosure { overflow: hidden; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 3px); background: rgb(var(--shade-canvas-02-rgb) / 56%); }.audit-disclosure.secondary { margin-top: 12px; }
...
.state-dot.handoff { background: var(--shade-ai-02); }.audit-disclosure.handoff { border-color: rgb(var(--shade-ai-02-rgb) / 24%); }
...
.audit-log { max-height: 390px; margin: 0; padding: 13px 14px; overflow: auto; border-top: 1px solid var(--color-border-default); background: var(--shade-canvas-02); color: var(--shade-secondary-10); font: 10px/1.62 var(--font-code); white-space: pre-wrap; overflow-wrap: anywhere; }
...
.diff-list { display: grid; gap: 1px; margin-top: 12px; overflow: hidden; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 3px); background: var(--color-border-default); }.diff-row { display: grid; grid-template-columns: 48px minmax(0, 1fr) auto; align-items: center; gap: 9px; width: 100%; padding: 8px 11px; border: 0; background: var(--shade-canvas-16); color: inherit; text-align: left; cursor: pointer; transition: background .15s ease; }.diff-row:hover, .diff-row:focus-visible { background: var(--shade-surface-19); outline: none; }.diff-row > svg { color: var(--color-text-muted); }.diff-row:hover > svg { color: var(--color-accent-cyan); }.diff-row code { min-width: 0; color: var(--color-text-secondary); font: 10px/1.45 var(--font-code); overflow-wrap: anywhere; }.diff-state { color: var(--shade-warning-01); font-size: 9px; font-weight: 700; }.diff-state.added { color: var(--color-success); }
.violation-box { margin-top: 12px; padding: 11px 12px; border: 1px solid rgb(var(--shade-border-01-rgb) / 30%); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-danger-01-rgb) / 7%); color: var(--color-task-danger); font-size: 10px; }.violation-box strong { display: flex; align-items: center; gap: 6px; }.violation-box ul { margin: 7px 0 0; padding-left: 20px; }.secondary-note { margin: 11px 2px 0; color: var(--color-text-tertiary); font-size: 9px; line-height: 1.55; }
.verification-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; margin-top: 12px; }.verification-card { min-width: 0; padding: 12px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 3px); background: rgb(var(--shade-canvas-17-rgb) / 65%); }.verification-card header { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 9px; }.verification-card header > div { display: grid; min-width: 0; gap: 2px; }.verification-card header strong { color: var(--color-text-primary); font: 700 11px/1.4 var(--font-code); }.verification-card header small { color: var(--color-text-tertiary); font-size: 9px; }.verification-icon { display: grid; width: 25px; height: 25px; place-items: center; border-radius: 50%; background: rgb(var(--shade-muted-01-rgb) / 12%); color: var(--color-text-muted); }.verification-icon.pass { background: rgb(var(--shade-success-01-rgb) / 10%); color: var(--color-success); }.verification-icon.fail { background: rgb(var(--shade-danger-01-rgb) / 10%); color: var(--color-task-danger); }.result-pill { padding: 4px 7px; border-radius: 999px; background: rgb(var(--shade-muted-01-rgb) / 10%); color: var(--color-text-tertiary); font-size: 9px; font-weight: 700; }.result-pill.pass { background: rgb(var(--shade-success-01-rgb) / 9%); color: var(--color-success); }.result-pill.fail { background: rgb(var(--shade-danger-01-rgb) / 9%); color: var(--color-task-danger); }.verification-card > p { margin: 10px 0 0; color: var(--color-text-secondary); font-size: 10px; }.verification-card > code { display: block; margin-top: 8px; padding: 7px 8px; overflow: hidden; border-radius: var(--radius-control); background: var(--shade-canvas-02); color: var(--shade-text-13); font: 9px/1.45 var(--font-code); text-overflow: ellipsis; white-space: nowrap; }.verification-meta { margin-top: 7px; color: var(--color-text-tertiary); font: 9px/1.45 var(--font-code); }.inline-output { margin-top: 9px; }.inline-output > summary { color: var(--color-accent-cyan); font-size: 9px; cursor: pointer; }.inline-output .audit-log { max-height: 250px; margin: 8px -12px -12px; }
:global(.diff-preview-dialog) { overflow: hidden; border: 1px solid rgb(var(--shade-secondary-05-rgb) / 18%); border-radius: calc(var(--radius-control) + 6px); background: var(--shade-canvas-03); box-shadow: var(--appearance-task-audit-evidence-panel-global-diff-preview-dialog-box-shadow); }
...
.preview-title { display: flex; align-items: center; gap: 11px; padding-right: 30px; }.preview-title > .diff-state { flex: 0 0 auto; padding: 5px 8px; border-radius: 999px; background: rgb(var(--shade-warning-02-rgb) / 10%); }.preview-title > .diff-state.added { background: rgb(var(--shade-success-01-rgb) / 10%); }.preview-title > div { display: grid; min-width: 0; gap: 3px; }.preview-title strong { color: var(--color-text-primary); font-size: 13px; }.preview-title code { overflow: hidden; color: var(--color-text-secondary); font: 10px/1.4 var(--font-code); text-overflow: ellipsis; white-space: nowrap; }
.preview-legend { display: flex; align-items: center; gap: 8px; padding: 9px 16px; border-bottom: 1px solid var(--color-border-default); background: rgb(var(--shade-canvas-18-rgb) / 60%); color: var(--color-text-tertiary); font-size: 9px; }.preview-legend span { padding: 3px 6px; border-radius: calc(var(--radius-control) - 2px); }.preview-legend .added { background: rgb(var(--shade-success-01-rgb) / 13%); color: var(--shade-success-04); }.preview-legend .removed { background: rgb(var(--shade-danger-01-rgb) / 13%); color: var(--shade-danger-02); }.preview-legend .hunk { background: rgb(var(--shade-cyan-01-rgb) / 11%); color: var(--shade-cyan-02); }.preview-legend b { margin-left: auto; color: var(--shade-warning-01); }
...
.diff-preview { max-height: min(68vh, 720px); overflow: auto; background: var(--shade-canvas-02); }.preview-line { display: grid; grid-template-columns: 52px max-content; min-width: 100%; width: max-content; color: var(--shade-secondary-11); font: 10px/1.58 var(--font-code); }.preview-line > span { position: sticky; left: 0; padding: 1px 10px; border-right: 1px solid rgb(var(--shade-secondary-05-rgb) / 10%); background: var(--shade-canvas-05); color: var(--shade-primary-04); text-align: right; user-select: none; }.preview-line > code { min-width: calc(min(92vw, 1040px) - 54px); padding: 1px 12px; color: inherit; font: inherit; white-space: pre; }.preview-line.added { background: rgb(var(--shade-success-01-rgb) / 13%); color: var(--shade-text-04); }.preview-line.removed { background: rgb(var(--shade-danger-01-rgb) / 13%); color: var(--shade-text-05); }.preview-line.hunk { background: rgb(var(--shade-cyan-01-rgb) / 9%); color: var(--shade-cyan-02); }.preview-line.header { color: var(--shade-muted-04); }.preview-line.added > span { background: var(--shade-surface-07); color: var(--shade-success-03); }.preview-line.removed > span { background: var(--shade-surface-08); color: var(--shade-danger-03); }.preview-line.hunk > span { background: var(--shade-surface-09); color: var(--shade-cyan-01); }
