...
.status-chip { display: inline-flex; padding: 3px 7px; border: 1px solid rgb(var(--shade-warning-02-rgb) / 28%); border-radius: 999px; background: rgb(var(--shade-warning-02-rgb) / 8%); color: var(--color-session-warning); font-size: 10px; }
.commit-message { margin-top: 16px; padding: 14px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 4px); background: rgb(var(--shade-canvas-02-rgb) / 48%); }.commit-message label { display: block; margin-bottom: 8px; color: var(--color-text-primary); font-size: 12px; }.commit-message p { margin: 7px 0 0; color: var(--color-text-tertiary); font-size: 10px; }
...
.cancel-confirmation { display: flex; width: 100%; align-items: center; justify-content: space-between; gap: 16px; padding: 10px 12px; border: 1px solid rgb(var(--shade-border-01-rgb) / 32%); border-radius: calc(var(--radius-control) + 4px); background: rgb(var(--shade-danger-01-rgb) / 8%); color: var(--color-task-error); text-align: left; }
