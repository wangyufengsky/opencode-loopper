    ...
    <div v-else class="monitor-layout">
      ...
      <article class="session-console">
        ...
        <div ref="stream" class="console-stream" aria-live="polite" @scroll="onStreamScroll">
          ...
          <section v-if="selected?.kind === 'IMPLEMENTATION'" class="todo-panel todo-panel-pinned" aria-label="OpenCode 实施计划">
...
@media (max-width: 640px) { .monitor-header { align-items: stretch; flex-direction: column; }.monitor-actions { justify-content: flex-start; }.todo-panel-pinned { position: static; max-height: none; overflow: hidden; box-shadow: none; } }
</style>
