...
.session-console { position: relative; display: grid; grid-template-rows: auto minmax(0, 1fr); min-width: 0; background: var(--shade-canvas-01); }.session-console.has-todo-dock { grid-template-rows: auto auto minmax(0, 1fr); }.console-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 15px; min-height: 48px; padding: 9px 14px; border-bottom: 1px solid var(--color-border-default); color: var(--color-text-muted); font-size: 9px; }.console-toolbar > div { display: flex; align-items: center; gap: 9px; }.console-toolbar strong { color: var(--color-text-primary); font-size: 11px; }.console-toolbar .mono { color: var(--color-accent-cyan); }.transport-dot { display: inline-block; width: 6px; height: 6px; border-radius: 50%; background: var(--color-text-muted); }.transport-dot.live { background: var(--color-success); box-shadow: var(--appearance-session-monitor-panel-transport-dot-live-box-shadow); }
