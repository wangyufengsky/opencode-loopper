...
@media (max-width: 640px) { .monitor-header { align-items: stretch; flex-direction: column; }.monitor-actions { justify-content: flex-start; }.todo-dock { display: contents; }.todo-dock :deep(.todo-panel) { margin: 15px 15px 0; } }
