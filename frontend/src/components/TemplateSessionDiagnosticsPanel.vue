...
button { border: 1px solid var(--color-border-default); border-radius: 6px; background: var(--color-bg-elevated); color: var(--color-text-primary); padding: 6px 10px; font: inherit; cursor: pointer; }
...
.diagnostic-rows { max-height: 580px; overflow: auto; }.diagnostic-row { margin-top: 10px; padding: 14px; border: 1px solid var(--color-border-default); border-radius: 8px; overflow-wrap: anywhere; }.diagnostic-row p { line-height: 1.6; }
