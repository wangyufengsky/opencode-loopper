...
<style scoped>
.publication-intro { display: flex; gap: 11px; padding: 12px; border: 1px solid rgb(var(--shade-ai-01-rgb) / 28%); border-radius: calc(var(--radius-control) + 3px); background: rgb(var(--shade-ai-01-rgb) / 7%); }.publication-intro > svg { flex: 0 0 auto; margin-top: 2px; color: var(--color-accent-ai); }.publication-intro strong { color: var(--color-text-primary); font-size: 12px; }.publication-intro p { margin: 5px 0 0; color: var(--color-text-secondary); font-size: 11px; }
.generation-state { display: flex; align-items: center; gap: 6px; margin: 7px 0 0; color: var(--color-accent-ai); font-size: 10px; }.commit-preview { display: grid; gap: 7px; padding: 12px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 2px); background: var(--shade-canvas-19); }.commit-preview span { color: var(--color-text-muted); font-size: 10px; }.commit-preview code { color: var(--shade-text-19); font: 12px/1.55 var(--font-code); overflow-wrap: anywhere; }
.publication-error { display: flex; align-items: flex-start; gap: 6px; margin: 10px 0 0; color: var(--color-task-danger); font-size: 11px; line-height: 1.5; }.publication-error > svg { flex: 0 0 auto; margin-top: 2px; }.branch-flow { display: flex; align-items: center; gap: 10px; padding: 11px 12px; border: 1px solid rgb(var(--shade-cyan-01-rgb) / 18%); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-cyan-01-rgb) / 4%); }.branch-flow code { min-width: 0; color: var(--color-accent-cyan); font: 10px/1.45 var(--font-code); overflow-wrap: anywhere; }.branch-flow > svg { flex: 0 0 auto; color: var(--color-text-muted); }.merge-note { display: flex; gap: 7px; margin: 0; color: var(--color-text-secondary); font-size: 10px; line-height: 1.55; }.merge-note > svg { flex: 0 0 auto; margin-top: 1px; }
.spin { animation: spin .8s linear infinite; }@keyframes spin { to { transform: rotate(360deg); } }
:global(.publication-dialog) { border: 1px solid rgb(var(--shade-secondary-05-rgb) / 18%); border-radius: calc(var(--radius-control) + 6px); background: var(--shade-canvas-03); box-shadow: var(--appearance-task-publication-actions-global-publication-dialog-box-shadow); }:global(.publication-dialog .el-dialog__header) { margin: 0; padding-bottom: 14px; border-bottom: 1px solid var(--color-border-default); }:global(.publication-dialog .el-dialog__body) { padding-top: 18px; }
.conflict-session-bar { display: flex; align-items: center; gap: 14px; min-width: 0; padding: 9px 12px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 2px); background: var(--shade-canvas-20); color: var(--color-text-secondary); font-size: 10px; }.conflict-session-bar span { display: flex; min-width: 0; align-items: center; gap: 6px; flex: 1; overflow-wrap: anywhere; }.conflict-session-bar code { color: var(--color-accent-cyan); }.conflict-session-bar strong { color: var(--shade-success-04); }.conflict-state { display: flex; align-items: center; gap: 8px; margin-top: 10px; padding: 9px 11px; border: 1px solid rgb(var(--shade-warning-01-rgb) / 30%); border-radius: calc(var(--radius-control) + 1px); background: rgb(var(--shade-warning-01-rgb) / 7%); color: var(--shade-warning-04); font-size: 10px; }.conflict-state span { flex: 1; }.conflict-state.danger { border-color: rgb(var(--shade-danger-05-rgb) / 32%); background: rgb(var(--shade-danger-05-rgb) / 8%); color: var(--shade-text-05); }
.conflict-workbench { display: grid; grid-template-columns: minmax(220px, 250px) minmax(0, 1fr); min-height: 590px; margin-top: 12px; overflow: hidden; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 3px); background: var(--shade-canvas-21); }.conflict-files { overflow: auto; border-right: 1px solid var(--color-border-default); background: var(--shade-canvas-22); }.conflict-files button { display: flex; width: 100%; gap: 8px; align-items: flex-start; padding: 10px; border: 0; border-bottom: 1px solid rgb(var(--shade-secondary-05-rgb) / 10%); background: transparent; color: var(--color-text-secondary); text-align: left; cursor: pointer; }.conflict-files button.active { background: rgb(var(--shade-cyan-01-rgb) / 8%); color: var(--shade-text-09); }.conflict-files button > svg { flex: 0 0 auto; margin-top: 1px; }.conflict-files button span { min-width: 0; }.conflict-files code { display: block; color: inherit; font: 10px/1.4 var(--font-code); overflow-wrap: anywhere; }.conflict-files small { display: block; margin-top: 4px; color: var(--color-text-muted); font-size: 9px; }.conflict-detail { display: flex; min-width: 0; min-height: 0; overflow-x: auto; flex-direction: column; }.resolution-toolbar { display: flex; min-width: 900px; justify-content: space-between; gap: 10px; padding: 9px 10px; border-bottom: 1px solid var(--color-border-default); }.merge-block-toolbar { display: grid; min-width: 900px; grid-template-columns: minmax(0, 1fr) auto auto; align-items: center; gap: 12px; min-height: 42px; padding: 7px 10px; border-bottom: 1px solid var(--color-border-default); background: var(--shade-canvas-22); }.merge-path { display: flex; min-width: 0; align-items: center; gap: 7px; color: var(--color-text-secondary); }.merge-path code { min-width: 0; overflow: hidden; color: var(--shade-text-19); font: 10px var(--font-code); text-overflow: ellipsis; white-space: nowrap; }.merge-path span { padding: 2px 5px; border: 1px solid rgb(var(--shade-cyan-01-rgb) / 26%); border-radius: calc(var(--radius-control) - 2px); color: var(--color-accent-cyan); font: 8px var(--font-code); }.merge-stats { display: flex; gap: 9px; color: var(--color-text-muted); font-size: 9px; }.merge-stats strong { color: var(--shade-success-04); }.merge-stats .danger { color: var(--shade-danger-02); }.merge-nav { display: flex; align-items: center; gap: 5px; }.merge-nav code { min-width: 42px; color: var(--color-text-secondary); font: 9px var(--font-code); text-align: center; }.merge-grid { display: grid; min-width: 900px; min-height: 470px; flex: 1; grid-template-columns: repeat(3, minmax(285px, 1fr)); gap: 1px; background: var(--color-border-default); }.conflict-detail > .merge-grid { overflow: hidden; }.merge-grid article { display: grid; min-width: 0; min-height: 0; grid-template-rows: auto 1fr; background: var(--shade-canvas-23); }.merge-grid header { display: flex; min-height: 34px; align-items: center; justify-content: space-between; gap: 8px; padding: 5px 9px; background: var(--shade-surface-20); color: var(--color-text-secondary); font-size: 9px; }.merge-grid header code { color: var(--color-text-muted); }.merge-grid .merge-result header { border-bottom: 1px solid rgb(var(--shade-success-03-rgb) / 24%); color: var(--shade-success-04); }.merge-grid header > span { color: inherit; font-weight: 700; }.block-actions { display: flex; gap: 4px; }.block-actions :deep(.el-button) { padding: 4px 5px; font-size: 8px; }.base-reference { min-width: 900px; border-top: 1px solid var(--color-border-default); background: var(--shade-canvas-24); }.base-reference header { display: flex; justify-content: space-between; padding: 6px 10px; color: var(--color-text-muted); font-size: 9px; }.base-reference pre { max-height: 180px; margin: 0; padding: 10px 14px; overflow: auto; border-top: 1px solid rgb(var(--shade-secondary-05-rgb) / 12%); white-space: pre; color: var(--shade-secondary-01); font: 10px/1.55 var(--font-code); }.non-text-resolution { display: flex; flex: 1; flex-direction: column; align-items: center; justify-content: center; gap: 8px; color: var(--color-text-secondary); }.non-text-resolution > svg { width: 32px; height: 32px; color: var(--shade-warning-01); }.non-text-resolution p { margin: 0; }.non-text-resolution code { max-width: 80%; overflow-wrap: anywhere; color: var(--color-text-muted); font-size: 9px; }.ai-suggestion { display: grid; min-width: 900px; grid-template-columns: 1fr auto; gap: 7px; padding: 9px; border-top: 1px solid rgb(var(--shade-ai-01-rgb) / 28%); background: rgb(var(--shade-ai-01-rgb) / 6%); }.ai-suggestion div { display: grid; gap: 3px; }.ai-suggestion strong { color: var(--shade-text-08); font-size: 10px; }.ai-suggestion span { color: var(--color-text-muted); font-size: 9px; }.ai-suggestion pre { grid-column: 1 / -1; max-height: 110px; margin: 0; overflow: auto; white-space: pre-wrap; color: var(--shade-secondary-06); font: 9px/1.45 var(--font-code); }.conflict-empty { display: grid; flex: 1; place-items: center; color: var(--color-text-muted); font-size: 11px; }
.merge-marker-warning { display: flex; align-items: flex-start; gap: 7px; padding: 9px 11px; border-top: 1px solid rgb(var(--shade-danger-05-rgb) / 30%); background: rgb(var(--shade-danger-05-rgb) / 8%); color: var(--shade-text-05); font-size: 10px; line-height: 1.5; }.merge-marker-warning > svg { flex: 0 0 auto; margin-top: 1px; }
.verification-failures { display: grid; gap: 7px; margin-top: 10px; padding: 10px; border: 1px solid rgb(var(--shade-danger-05-rgb) / 28%); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-danger-05-rgb) / 6%); }.verification-failures > strong { color: var(--shade-text-05); font-size: 10px; }.verification-failures article { overflow: hidden; border: 1px solid rgb(var(--shade-secondary-05-rgb) / 16%); border-radius: var(--radius-control); background: var(--shade-canvas-21); }.verification-failures header { display: flex; gap: 10px; justify-content: space-between; padding: 7px 9px; color: var(--shade-danger-02); font-size: 9px; }.verification-failures pre { max-height: 180px; margin: 0; padding: 9px; overflow: auto; border-top: 1px solid rgb(var(--shade-secondary-05-rgb) / 14%); white-space: pre-wrap; color: var(--shade-text-20); font: 9px/1.45 var(--font-code); }
:global(.local-sync-dialog) { border: 1px solid rgb(var(--shade-secondary-05-rgb) / 22%); border-radius: calc(var(--radius-control) + 6px); background: var(--shade-canvas-20); box-shadow: var(--appearance-task-publication-actions-global-local-sync-dialog-box-shadow); }:global(.local-sync-dialog .el-dialog__header) { margin: 0; padding-bottom: 12px; border-bottom: 1px solid var(--color-border-default); }:global(.local-sync-dialog .el-dialog__body) { padding: 14px 16px 8px; }
