...
<style scoped>
.lifecycle { margin-top: 16px; border-color: rgb(var(--shade-ai-01-rgb) / 28%); background: var(--appearance-session-lifecycle-panel-lifecycle-background); }.lifecycle-actions { display: flex; flex-wrap: wrap; gap: 8px; margin: 14px 0; }.lifecycle-actions button,.text-button { border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 1px); padding: 7px 10px; color: var(--color-text-secondary); background: rgb(var(--shade-canvas-02-rgb) / 78%); font-size: 12px; cursor: pointer; }.lifecycle-actions button:hover:not(:disabled),.text-button:hover:not(:disabled) { color: var(--color-text-primary); border-color: var(--color-accent); }.lifecycle-actions button:disabled,.text-button:disabled { opacity: .48; cursor: not-allowed; }.refs { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }.refs label { display: grid; gap: 5px; color: var(--color-text-tertiary); font-size: 10px; }.refs input { min-width: 0; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 1px); padding: 8px 9px; color: var(--color-text-primary); background: rgb(var(--shade-canvas-11-rgb) / 85%); font: 11px var(--font-code); }.snapshot-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 12px; margin-top: 14px; }.snapshot-grid article { min-width: 0; padding: 11px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-canvas-11-rgb) / 48%); }.snapshot-grid h3 { margin: 0 0 9px; color: var(--color-text-primary); font-size: 12px; }.snapshot-grid ol { display: grid; gap: 7px; padding: 0; margin: 0; list-style: none; }.snapshot-grid li { display: grid; gap: 3px; color: var(--color-text-secondary); font-size: 12px; }.snapshot-grid small,.lifecycle-hint { color: var(--color-text-tertiary); font: 10px var(--font-code); }.snapshot-grid code { overflow: hidden; color: var(--shade-secondary-06); font-size: 10px; text-overflow: ellipsis; }.lifecycle-error { color: var(--color-danger); font-size: 12px; }.lifecycle-hint { margin: 0 0 10px; }.muted { color: var(--color-text-tertiary); font-size: 12px; }@media (max-width: 760px) { .refs,.snapshot-grid { grid-template-columns: 1fr; } }
</style>
