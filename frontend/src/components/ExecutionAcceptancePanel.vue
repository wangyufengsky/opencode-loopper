...
<style scoped>
.acceptance-panel { min-width: 0; max-width: 100%; margin: 0 20px 14px; padding: 13px; border: 1px solid rgb(var(--shade-cyan-01-rgb) / 18%); border-radius: calc(var(--radius-control) + 4px); background: rgb(var(--shade-cyan-01-rgb) / 4%); }
.acceptance-panel > header { display: flex; align-items: flex-start; gap: 9px; min-width: 0; }.acceptance-panel > header > div { min-width: 0; }.acceptance-icon { display: grid; flex: 0 0 auto; place-items: center; width: 27px; height: 27px; border-radius: calc(var(--radius-control) + 1px); color: var(--color-accent-cyan); background: rgb(var(--shade-cyan-01-rgb) / 9%); }.acceptance-panel header strong { color: var(--color-text-primary); font-size: 11px; }.acceptance-panel header p { margin: 3px 0 0; color: var(--color-text-muted); font-size: 9px; line-height: 1.5; overflow-wrap: anywhere; }
.acceptance-stages { display: grid; min-width: 0; gap: 8px; margin-top: 11px; }.acceptance-stage { min-width: 0; padding: 9px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 1px); background: rgb(var(--shade-canvas-01-rgb) / 45%); }.acceptance-stage.weak { border-color: rgb(var(--shade-warning-02-rgb) / 28%); }.stage-title { display: flex; align-items: flex-start; gap: 8px; min-width: 0; }.stage-title span { flex: 0 0 auto; color: var(--color-accent-ai); font: 750 8px/1.5 var(--font-code); }.stage-title strong { min-width: 0; color: var(--color-text-secondary); font-size: 9px; line-height: 1.5; overflow-wrap: anywhere; white-space: normal; }.verifier-list { display: flex; flex-wrap: wrap; min-width: 0; gap: 5px; margin-top: 8px; }.verifier-chip { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: start; gap: 5px; max-width: 100%; padding: 5px 7px; border-radius: calc(var(--radius-control) - 1px); color: var(--color-text-secondary); background: rgb(var(--shade-muted-01-rgb) / 10%); font: 8px/1.35 var(--font-code); }.verifier-chip b { color: var(--color-accent-cyan); }.verifier-detail { min-width: 0; overflow-wrap: anywhere; white-space: normal; }.weak-warning { display: flex; align-items: flex-start; gap: 5px; margin: 8px 0 0; color: var(--color-session-warning); font-size: 8px; line-height: 1.45; overflow-wrap: anywhere; }.weak-warning svg { flex: 0 0 auto; }.acceptance-empty { margin: 10px 0 0 36px; color: var(--color-session-warning); font-size: 9px; }
.acceptance-subtitle { margin-top: 9px; color: var(--color-text-muted); font: 700 8px/1.4 var(--font-code); text-transform: uppercase; }.judge-title { color: var(--color-accent-ai); }.judge-list { display: grid; gap: 5px; margin-top: 6px; }.judge-item { padding: 7px; border: 1px solid rgb(var(--shade-ai-01-rgb) / 22%); border-radius: var(--radius-control); background: rgb(var(--shade-ai-01-rgb) / 6%); }.judge-item > span { display: flex; gap: 7px; align-items: center; }.judge-item code { color: var(--color-accent-ai); font-size: 8px; }.judge-item b { color: var(--color-text-secondary); font-size: 8px; }.judge-item p, .judge-item small { display: block; margin: 4px 0 0; color: var(--color-text-muted); font-size: 8px; line-height: 1.45; overflow-wrap: anywhere; }
</style>
