...
export const demoRuntime: RuntimeInfo = {
  loopperVersion: '0.1.49', status: 'ONLINE', version: '1.18.12', managed: true, pid: 44892, endpoint: '127.0.0.1:40971', model: 'opencode/deepseek-v4-flash-free', checkedAt: now,
}
