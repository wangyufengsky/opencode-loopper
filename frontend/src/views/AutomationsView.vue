...
import AutomationHealth from '@/components/AutomationHealth.vue'
...
<style scoped>
.automation{display:grid;gap:16px}.grid{display:grid;grid-template-columns:1.15fr .85fr;gap:16px}.lower{grid-template-columns:1fr 1fr}.pad{padding:17px}.pad h2{margin:0 0 13px;font-size:15px}.form{display:grid;gap:8px}.form input,.form select,.form textarea,.pad>textarea{width:100%;padding:9px;border:1px solid var(--color-border-default);border-radius:var(--radius-control);color:var(--color-text-primary);background:var(--shade-canvas-28);font:11px var(--font-code)}textarea{min-height:74px;resize:vertical}.guard,.notice,.server-time{margin:0;color:var(--color-text-secondary);font-size:11px;line-height:1.55}.guard{padding:10px;border-left:2px solid var(--color-accent-ai);background:rgb(var(--shade-ai-01-rgb) / 7%)}.notice{padding:10px;border:1px solid rgb(var(--shade-cyan-01-rgb) / 25%);border-radius:calc(var(--radius-control) + 2px);color:var(--shade-text-13);background:rgb(var(--shade-cyan-01-rgb) / 6%)}.server-time{font-family:var(--font-code)}.item{display:grid;gap:5px;margin-top:10px;padding:10px;border:1px solid var(--color-border-default);border-radius:calc(var(--radius-control) + 2px);background:rgb(var(--shade-canvas-07-rgb) / 35%)}.item b{font-size:12px}.item span,.item small,.item p{margin:0;color:var(--color-text-secondary);font-size:10px}.token{color:var(--shade-warning-03)!important}.actions{display:flex;gap:8px;margin:9px 0}.preview{margin-top:10px;padding:10px;border:1px solid rgb(var(--shade-cyan-01-rgb) / 28%);border-radius:calc(var(--radius-control) + 2px);background:rgb(var(--shade-cyan-01-rgb) / 5%);font-size:11px}.empty{padding:22px 4px;color:var(--color-text-muted);font-size:11px}.history{overflow:auto}table{width:100%;border-collapse:collapse;font-size:11px}th,td{padding:10px;border-bottom:1px solid var(--color-border-default);text-align:left;vertical-align:top}th{color:var(--color-text-muted);font:700 9px var(--font-code)}td{color:var(--color-text-secondary)}@media(max-width:900px){.grid,.lower{grid-template-columns:1fr}}
</style>
