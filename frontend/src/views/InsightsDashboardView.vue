...
.insight-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-bottom:16px}.insight-metrics article,.insight-row{padding:16px;background:var(--appearance-insights-dashboard-view-insight-metrics-article-background)}.insight-metrics span,.insight-metrics small,dt{color:var(--color-text-muted);font:700 10px/1.4 var(--font-code)}.insight-metrics strong{display:block;margin:10px 0 5px;color:var(--color-text-primary);font-size:24px}.insight-metrics .costs{font-size:13px;line-height:1.55}.insight-list{display:grid;gap:12px}.insight-row header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.insight-row h2{margin:0;font-size:15px}.quality{--quality-accent:var(--color-session-warning);--quality-border:rgb(var(--shade-warning-02-rgb) / 24%);--quality-surface:rgb(var(--shade-warning-02-rgb) / 7%);display:inline-flex;align-items:center;flex:0 0 auto;gap:7px;min-height:28px;padding:3px 10px 3px 5px;border:1px solid var(--quality-border);border-radius:calc(var(--radius-control) + 1px);color:var(--quality-accent);background:linear-gradient(135deg,var(--quality-surface),rgb(var(--shade-canvas-01-rgb) / 38%));box-shadow:var(--appearance-insights-dashboard-view-quality-box-shadow);font:650 10px/1 var(--font-ui);letter-spacing:.03em;white-space:nowrap}.quality-icon{display:grid;place-items:center;width:18px;height:18px;border:1px solid var(--quality-border);border-radius:calc(var(--radius-control) - 1px);background:var(--quality-surface);font-size:12px}.quality-pass{--quality-accent:var(--shade-success-06);--quality-border:rgb(var(--shade-success-01-rgb) / 25%);--quality-surface:rgb(var(--shade-success-01-rgb) / 8%)}.quality-review_required{--quality-accent:var(--shade-warning-06);--quality-border:rgb(var(--shade-warning-02-rgb) / 24%);--quality-surface:rgb(var(--shade-warning-02-rgb) / 7%)}.quality-pending{--quality-accent:var(--shade-secondary-14);--quality-border:rgb(var(--shade-secondary-12-rgb) / 20%);--quality-surface:rgb(var(--shade-secondary-12-rgb) / 6%)}.insight-row dl{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1px;margin:15px 0 0;background:var(--color-border-default)}.insight-row dl div{padding:10px;background:rgb(var(--shade-canvas-07-rgb) / 40%)}dd{margin:6px 0 0;color:var(--color-text-secondary);font-size:11px}dd small{color:var(--color-session-warning)}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}@media(max-width:800px){.insight-metrics,.insight-row dl{grid-template-columns:1fr}}
