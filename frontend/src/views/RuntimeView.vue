...
@media (max-width: 640px) { .guardrail-grid { grid-template-columns: 1fr; }.definition-list div { align-items: flex-start; flex-direction: column; }.definition-list dd { max-width: 100%; overflow-wrap: anywhere; text-align: left; } }
</style>
