...
<style scoped>
.recovery-layout { display: grid; grid-template-columns: minmax(0, 1.1fr) minmax(330px, .9fr); gap: 16px; }.context-card, .mode-card, .lineage-card { overflow: hidden; background: var(--appearance-recovery-studio-view-context-card-background); box-shadow: var(--appearance-recovery-studio-view-context-card-box-shadow); }.section-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; padding: 18px 19px 14px; border-bottom: 1px solid var(--color-border-default); }.section-header h2 { margin: 4px 0 0; font-size: 15px; }.section-header > svg { color: var(--color-accent-cyan); }.terminal-chip { padding: 5px 7px; border: 1px solid rgb(var(--shade-secondary-01-rgb) / 30%); border-radius: var(--radius-control); color: var(--color-text-secondary); background: rgb(var(--shade-secondary-01-rgb) / 8%); font: 700 8px/1 var(--font-code); }.terminal-chip.is-failed { border-color: rgb(var(--shade-danger-05-rgb) / 42%); color: var(--shade-danger-02); background: rgb(var(--shade-danger-01-rgb) / 10%); }.terminal-chip.is-cancelled { border-color: rgb(var(--shade-warning-01-rgb) / 38%); color: var(--shade-warning-04); background: rgb(var(--shade-warning-02-rgb) / 10%); }.context-body { padding: 17px 19px 19px; }.goal { margin: 0; color: var(--color-text-primary); font-size: 12px; line-height: 1.65; white-space: pre-wrap; }.context-facts { display: grid; grid-template-columns: 1fr 1.4fr; gap: 1px; margin: 15px 0; background: var(--color-border-default); }.context-facts div { min-width: 0; padding: 10px; background: rgb(var(--shade-canvas-07-rgb) / 46%); }.context-facts dt, .lineage-card dt { color: var(--color-text-muted); font: 700 8px/1.3 var(--font-code); letter-spacing: .08em; text-transform: uppercase; }.context-facts dd, .lineage-card dd { margin: 5px 0 0; overflow-wrap: anywhere; color: var(--color-text-secondary); font-size: 10px; line-height: 1.45; }.failure-list { display: grid; gap: 7px; }.failure-list article { display: flex; gap: 8px; padding: 10px; border: 1px solid rgb(var(--shade-border-01-rgb) / 20%); border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-elevated-12-rgb) / 10%); }.failure-list > article > svg { flex: 0 0 auto; margin-top: 1px; color: var(--shade-danger-05); }.failure-list code { color: var(--shade-danger-02); font-size: 9px; }.failure-list p { margin: 4px 0 0; color: var(--color-text-secondary); font-size: 10px; line-height: 1.5; }.no-failures, .mode-description, .safety-note { display: flex; align-items: flex-start; gap: 7px; margin: 0; color: var(--color-text-secondary); font-size: 10px; line-height: 1.55; }.no-failures svg, .mode-description svg, .safety-note svg { flex: 0 0 auto; margin-top: 1px; color: var(--color-accent-cyan); }.mode-card { padding-bottom: 18px; }.mode-options { display: grid; gap: 8px; padding: 16px 18px 11px; }.mode-option { display: flex; align-items: center; gap: 10px; padding: 11px; border: 1px solid var(--color-border-default); border-radius: calc(var(--radius-control) + 3px); cursor: pointer; background: rgb(var(--shade-canvas-07-rgb) / 35%); }.mode-option.selected { border-color: rgb(var(--shade-cyan-01-rgb) / 52%); background: rgb(var(--shade-cyan-01-rgb) / 8%); box-shadow: var(--appearance-recovery-studio-view-mode-option-selected-box-shadow); }.mode-option input { accent-color: var(--shade-cyan-01); }.mode-option b { display: block; color: var(--color-text-primary); font-size: 11px; }.mode-option small { display: block; margin-top: 4px; color: var(--color-text-muted); font: 8px/1 var(--font-code); }.mode-description, .safety-note { margin: 0 18px 10px; padding: 10px; border-radius: calc(var(--radius-control) + 2px); background: rgb(var(--shade-cyan-01-rgb) / 5%); }.safety-note { color: var(--shade-secondary-06); background: rgb(var(--shade-ai-01-rgb) / 7%); }.safety-note svg { color: var(--shade-secondary-06); }.mode-card :deep(.el-button) { margin: 5px 18px 0; }.ineligible { display: grid; place-items: center; min-height: 240px; padding: 24px; color: var(--color-text-muted); text-align: center; }.ineligible svg { color: var(--shade-warning-01); }.ineligible strong { margin-top: 9px; color: var(--color-text-primary); font-size: 13px; }.ineligible p { max-width: 280px; margin: 7px 0 0; font-size: 10px; line-height: 1.55; }.lineage-card { grid-column: 1 / -1; }.lineage-entry + .lineage-entry { border-top: 1px solid var(--color-border-default); }.lineage-flow { display: flex; align-items: center; gap: 10px; padding: 18px 19px; color: var(--color-accent-cyan); }.lineage-flow code { max-width: 42%; overflow: hidden; color: var(--color-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: 10px; }.lineage-card dl { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 1px; margin: 0; background: var(--color-border-default); }.lineage-card dl div { min-width: 0; padding: 11px; background: rgb(var(--shade-canvas-07-rgb) / 46%); }.fingerprint { font-family: var(--font-code); }.lineage-card :deep(.el-button) { margin: 15px 19px 19px; }.recovery-error { grid-column: 1 / -1; }.recovery-empty { min-height: 300px; }@media (max-width: 900px) { .recovery-layout { grid-template-columns: 1fr; }.lineage-card { grid-column: auto; }.lineage-card dl { grid-template-columns: repeat(2, minmax(0, 1fr)); } }@media (max-width: 560px) { .context-facts, .lineage-card dl { grid-template-columns: 1fr; } }
</style>
