...
export const SOURCE_TEMPLATE_STATES = ['PENDING_START', 'PREPARING', 'DESIGNING', 'EXECUTING', 'WRITING',
  'REVIEWING', 'REPORTING', 'WAITING_INPUT', 'STOPPING', 'CANCELLED', 'COMPLETED'] as const
